...
def repeated_inputs(option_number):
    ...
    # Everytime the user enters an input, this function is called to increment the respective count variable.
...
def random_event(outcomes):
    ...
    element = random.choice(outcomes)
    if val <= 5:
        pass
    else:
        print(element)
...
while counter < 3:
    ...
    if response == 1: # Checks if the user selected the first option in the "options" list
        print("The window is sealed")

    elif response == 2 or response == 3: #Checks if the user selected the second or third options in the "options" list
...
count1, count2, count3, count4 = 0, 0, 0, 0  # Resets count variables for the new responses
response = get_user_response()
outcomes = ["You took too long trying to unscrew the door. The Ghost Killer has found and killed you.",
            "You made too much noise trying to unscrew the door. The Ghost Killer has found and killed you."] # Extra lose scenarios for scenario 2
while True:
    ...
    elif response == 2: # Checks if the user selected the second option in the "options" list
    ...
    elif response == 3: # Checks if the user selected the third option in the "options" list
...
while True:
    # This while True loop is responsible for ...
    if response == 1:
        random_event(outcomes)
...
outcomes = ["You took too long to find an anchor for the rope. The Ghost Killer has found and killed you.",
            "You made too much while dragging the rope. The Ghost Killer has found and killed you."]
while True:
    if response == 1:
        random_event(outcomes)
